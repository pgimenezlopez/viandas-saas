...
| :---: | :---: | :---: | :--- | :--- |
| 🏃‍♂️ | 🔴 Alta | `Setup` | **Limpiar Base de Datos:** Ejecutar comando SQL `DELETE` para vaciar los pedidos de prueba antes del lanzamiento oficial. | - |
...
| 📋 | 🟣 Vision | `IA / Automatización` | **Carga de Menú vía WhatsApp + IA:** Crear un bot de WhatsApp donde la administradora pase los platos por texto/audio. Usar Gemini para estructurar el JSON e inyectar el menú nuevo directo en Supabase. | - |
